...
val DataMaterialTopic = mapOf(
    "transformasi_geometri" to listOf("Pengantar", "Translasi", "Refleksi", "Rotasi", "Dilatasi", "Kuis", "Hasil Belajar"),
    "lingkaran" to listOf("Pengantar", "Unsur-unsur", "Keliling", "Luas", "Kuis")
)

val TranslateIndicator = listOf(
...
val DataMaterialStep = mapOf(
    "transformasi_geometri" to listOf(
        "Translasi: Bangun tidak berubah bentuk/ukuran, hanya posisi.",
        "Refleksi: Jarak ke cermin sama dengan jarak bayangan ke cermin.",
        "Rotasi: Berputar terhadap titik pusat.",
        "Dilatasi: Perubahan ukuran bangun."
    )
)

val DataMaterials = listOf(
    MaterialItem("transformasi_geometri", "Transformasi Geometri", R.drawable.img_geo, "11"),
    MaterialItem("lingkaran", "Lingkaran", R.drawable.img_geo, "11")
)
...
val validatorQuestion = listOf(
    ...
    ValidatorQuestion("me6", "Media mudah for dioperasikan.", 2, "Kemudahan Penggunaan"),
    ValidatorQuestion("me7", "Gambar yang disajikan terlihat jelas and tidak terpecah-pecah.", 2, "Kualitas tampilan"),
